...
**Affected Systems:** Mac OS X 10.4 → 10.5 in‑place upgrader, Loginwindow launch sequence, DYLD_INSERT_LIBRARIES runtime environment, Third‑party device driver stacks (Logitech-era), Crash log triage heuristics  
**Case Number:** LLG-040X-ANLAS  
**Classification:** internal  
**Concepts:** app-enhancement, mascots, feature-creep, deprecated  
**Date:** 2007-10-27  
...
**Mascot Ref:** 075.anlas-appenhancer  
...
**Version Label:** Leopard Transition Incident Block 1  
